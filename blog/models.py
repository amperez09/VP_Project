...
class Bitacora(models.Model):
    ...
    horasLaborables = models.FloatField(null=True, default=0)
    horasVacaciones = models.IntegerField(null=True, default=0)
    horasEnfermedad = models.IntegerField(null=True, default=0)
    horasEspeciales = models.IntegerField(null=True, default=0)
    horasPorcentaje = models.FloatField(null=True, default=0)
    observaciones = models.CharField(max_length=300,null=True, default="")
